...
# 📅 Event Management System (Typescript + Graphql + PostgreSql)

This is a modern, secure, and full-featured Event Management System built on **typescript** with the **Express** framework and **PostgreSql** and **Graphql**. It offers a robust user module with secure email verification and advanced event management capabilities, including an invitation system and filtering.
